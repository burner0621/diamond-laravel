...
@section('content')
            ...
            <div class="col-sm mb-2 mb-sm-0">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-no-gutter">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Create Shipping Method</li>
                    </ol>
                </nav>

                <h1 class="page-header-title">Add Shipping Method</h1>
    ...
    <div class="container">
        <form action="{{ route('backend.shipping.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row mb-3">
