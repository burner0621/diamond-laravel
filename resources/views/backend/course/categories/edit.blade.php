@extends('backend.layouts.app', ['activePage' => 'posts', 'title' => 'Edit Blog Category', 'navName' => 'Table List', 'activeButton' => 'courses'])
...
<div class="page-header">
    ...
    <!-- End Row -->
            ...
            <div class="row">
                <div class="col-md-12">
                    <form action="{{route('backend.courses.categories.update', $category->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <select class="selectpicker" name="parent_id" data-live-search="true">
                                                    ...
                                                    @foreach ($arrCourseCategories as $category_item)
                                                        <option value="{{$category_item->id}}"
                                                            @if($category_item->id == $category->parent_id) selected @endif
                                                            data-tokens="{{$category_item->category_name}}"
