...
<div class="row">
    ...
    <div class="col-lg-8">
        <div class="card rounded-0 mb-4">
            <div class="card-header card-header-content-md-between">
                <div class="mb-2 mb-md-0">
                    <h3 class="card-header-title mb-0">Product Tags</h3>
                </div>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="btn-group" role="group">
                                            <a class="btn btn-dark btn-sm" href="{{ route('backend.products.tags.edit', $tag->id) }}">Edit</a>
                                            <!-- Button Group -->
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end mt-1" aria-labelledby="ordersExportDropdown1" style="">
                                                    ...
                                                    <a class="dropdown-item text-danger" onclick="return confirm('Are you sure you want to delete this product?')" href="{{ route("backend.products.tags.delete", $tag->id) }}">Delete</a>
                                                </div>
                                            </div>
                                            <!-- End Unfold -->
                                        </div>
