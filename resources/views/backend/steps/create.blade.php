@extends('backend.layouts.app', ['activePage' => 'steps', 'title' => 'Create Step', 'navName' => 'addstep', 'activeButton' => 'blog'])

@section('content')
<div class="page-header">
    <div class="row align-items-end">
        <h1 class="page-header-title">Create step</h1>
    </div>
    <!-- End Row -->
</div>
<form action="{{ route('backend.steps.store') }}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="row">
        <div class="col-md-8">
            <div class="card col-md-12 mb-4">
                ...
                <div class="card-body row">
                    ...
                    <div class="mb-2">
                        ...
                        <textarea name="link" id="txaLink" class="form-control"
                        >{{ old('link') }}</textarea>
                    </div>
                </div>
            </div>
