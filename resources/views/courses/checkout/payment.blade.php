<x-guest-layout page-title="Shipping Detail">
                  ...
                  <div class="col-lg-6">
                      <div class="col-xl-8 col-lg-10 ml-auto p-3">
                          ...
                          <nav class="pb-4" aria-label="breadcrumb">
                              <ol class="breadcrumb">
                                  <li class="breadcrumb-item"><a href="/courses/course/{{ $course->slug }}">Services</a></li>
                                  <li class="breadcrumb-item" aria-current="page"><a href="courses/checkout/{{$course->id}}/">Billing</a></li>
  ...
  <script>
      ...
      const payment_intent_route = '/courses/checkout/intent/{{ $course->id }}';
      const _token = '{{ csrf_token() }}';
      const place_order_route = '/courses/checkout/store/{{ $course->id }}';
      const order_cancel_route = '{{ route('courses.cancel') }}';
      const finish_page = '{{ route('courses.finish') }}';
